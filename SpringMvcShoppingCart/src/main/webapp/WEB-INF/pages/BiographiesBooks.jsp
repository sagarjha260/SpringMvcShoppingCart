  ...
  display:inline;
	...
	<body>  
	   ...
	   <ul id="menu">
  		...
  		<div class="page-title">Biography Books</div>
  		<c:forEach items="${biographies}" var="prodInfo">
	   ...
	   <br/>    
	   <a href="/BiographiesBooksByPage/1">1</a>     
	   <a href="/BiographiesBooksByPage/10">2</a>     
	   <a href="/BiographiesBooksByPage/20">3</a>
	   <a href="/BiographiesBooksByPage/30">4</a>  
	   <a href="/BiographiesBooksByPage/40">5</a>    
