  ...
  display:inline;
	...
	<body>  
	   ...
	   <ul id="menu">
  		...
  		<div class="page-title">Literature & Fiction Books</div>
  		<c:forEach items="${literature}" var="prodInfo">
	   ...
	   <br/>    
	   <a href="/LiteratureBooksByPage/1">1</a>     
	   <a href="/LiteratureBooksByPage/10">2</a>     
	   <a href="/LiteratureBooksByPage/20">3</a>
	   <a href="/LiteratureBooksByPage/30">4</a>  
	   <a href="/LiteratureBooksByPage/40">5</a>    
