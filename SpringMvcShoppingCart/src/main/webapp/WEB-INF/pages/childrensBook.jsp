...
ul#menu li {
  display:inline;
	...
	<body>  
	   ...
	   <hr>
	   <ul id="menu">
	      <li><a href="${pageContext.request.contextPath}/ChildrensBooks/Childrens Books">Children's Books &emsp;&emsp;&emsp;&emsp;</li>
          <li><a href="${pageContext.request.contextPath}/BiographiesBooks/Biographies">Biographies & Memoirs &emsp;&emsp;&emsp;&emsp;</li>
  		...
  		<div class="page-title">Children's Books</div>
  		<c:forEach items="${children}" var="prodInfo">
	   ...
	   <br/>    
	   <a href="/ChildrensBooksByPage/1">1</a>     
	   <a href="/ChildrensBooksByPage/10">2</a>     
	   <a href="/ChildrensBooksByPage/20">3</a>
	   <a href="/ChildrensBooksByPage/30">4</a>  
	   <a href="/ChildrensBooksByPage/40">5</a>        
